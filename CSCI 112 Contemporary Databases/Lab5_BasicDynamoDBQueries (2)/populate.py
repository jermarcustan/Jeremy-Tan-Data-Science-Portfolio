...
if __name__ == '__main__':
    ...
    order.checkout("aarchamb", "home", shopping_cart1, "Shipped", "2021-01-10")
    order.checkout("tgrimes1", "home", shopping_cart2, "Pending", "2020-08-21")
    order.checkout("tgrimes1", "home", shopping_cart3, "Pending", "2020-09-13")
